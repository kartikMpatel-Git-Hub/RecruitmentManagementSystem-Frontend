          ...
          <div className="flex items-center justify-between">
            <div className="flex items-center gap-4">
              ...
              <div>
                ...
                <p className="text-gray-600 text-lg">View and manage all system candidates</p>
              </div>
            </div>
          </div>
        </div>
      ...
      <div className="bg-white rounded-3xl shadow-xl border border-gray-200 p-8">
        {candidates.length === 0 ? (
          <div className="text-center py-16">
            ...
            <p className="text-gray-600 text-lg">There are no candidates in the system at the moment.</p>
          </div>
        ) : (
