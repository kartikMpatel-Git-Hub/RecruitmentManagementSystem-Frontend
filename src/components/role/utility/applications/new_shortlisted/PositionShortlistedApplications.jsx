...
function PositionShortlistedApplications() {
  ...
  const navigateToPosition = (posId) => {
    navigate(`/${userType.toLowerCase()}/positions/${posId}`);
  };
          ...
          <div className="flex items-center gap-4">
            ...
            <div>
              ...
              <p className="text-gray-600 text-lg">
                Position #{positionId} • Total: {pagination.totalItems} applications
              </p>
            </div>
          </div>
        </div>
