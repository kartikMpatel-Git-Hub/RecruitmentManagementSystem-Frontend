  ...
  const fetchShortlistedApplications = async () => {
    try {
      const response = await axios.get(
        `http://localhost:8080/shortlisted-applications/position/${positionId}`,
        ...
        <div className="bg-white rounded-3xl shadow-xl border border-gray-200 p-8 mb-8">
          <div className="flex items-center gap-4">
            ...
            <div>
              ...
              <p className="text-gray-600 text-lg">Shortlisted candidates for Position ID: {positionId}</p>
            </div>
          </div>
        </div>
            ...
            <div className="bg-white rounded-3xl shadow-xl border border-gray-200 overflow-hidden">
              <table className="w-full">
                <thead className="bg-gradient-to-r from-slate-800 to-slate-900">
                  <tr>
                    <th className="px-6 py-4 text-left text-sm font-semibold text-white">Shortlisted ID</th>
                  ...
                  {shortlistedApplications
                    ...
                    <tr key={app.shortlistedApplicationId} className="hover:bg-gray-50 transition-colors">
                      <td className="px-6 py-4">
                        <span className="font-semibold text-gray-900">#{app.shortlistedApplicationId}</span>
                      </td>
                      <td className="px-6 py-4">
                        <span className="text-gray-900 font-medium">#{app.application?.applicationId}</span>
                      </td>
                      <td className="px-6 py-4">
